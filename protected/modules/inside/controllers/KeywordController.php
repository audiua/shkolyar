...
class KeywordController extends InsideController
{
	...
	public function actionPosition(){
		...
		$all['today'] = Keyword::model()->with('position:today')->findAll();
		$all['one'] = Keyword::model()->with('position:one')->findAll();
		$all['two'] = Keyword::model()->with('position:two')->findAll();
		$all['three'] = Keyword::model()->with('position:three')->findAll();
		// $one = Keyword::model()->with('position')->findAll();
		// $one = Keyword::model()->findAll();

		$this->render('position', array('all'=>$all));
	}
}
