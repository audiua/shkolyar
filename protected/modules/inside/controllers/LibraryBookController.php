...
class LibraryBookController extends InsideController
{
	 ...
	 * @return LibraryBook the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=LibraryBook::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param LibraryBook $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='library-book-form')
		{
