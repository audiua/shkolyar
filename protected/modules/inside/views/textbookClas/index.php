...
$('.search-form form').submit(function(){
	$('#textbook-clas-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="title">Manage Textbook Clases</div> <a class="btn btn-success" href="<?php echo $this->createUrl('create'); ?>" role="button"> + Створити</a>
<div class="clear"></div>
