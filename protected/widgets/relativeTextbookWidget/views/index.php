<div class="book-list">
	<?php foreach($model as $data) :
		...
		<div class="small-book-block">
			...
			<div class=""> 
				<?php 
				echo SeoHide::link('/textbook/'.$data->textbook_clas->clas->slug.'/'.$data->textbook_subject->slug.'/'.$data->slug, CHtml::image($data->getThumb(140,200,'resize')));
			...
			<div class="textbook-link">
				<?php echo CHtml::link( 'Підручник', array('/textbook/'.$data->textbook_clas->clas->slug.'/'.$data->textbook_subject->slug.'/'.$data->slug), array('class'=>'btn btn-warning btn-xs')); ?>
			</div>
