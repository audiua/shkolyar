...
class RelativeGdzWidget extends CWidget{
	...
	public function run(){
		if($this->beginCache('relative_books_'.$this->controller->bookModel->id) ){

			// передаем данные в представление виджета
	        $this->render('index',array('model' => $this->relatedBooks($this->countBook)));

	        $this->endCache(); 
		}
    }

	private function relatedBooks($count){
		$books = array();
